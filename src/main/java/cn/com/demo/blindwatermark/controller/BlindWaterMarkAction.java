...
//    Mat srcImg = Utils.read(srcFile.getAbsolutePath(), CV_8U);

    if (!srcFile.getAbsolutePath().isEmpty()) {
      ...
      BlindWaterMarkUtil.encode(srcFile.getAbsolutePath(), isText, text, newFile);
